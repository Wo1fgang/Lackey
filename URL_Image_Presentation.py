...
def Insert_URL_Image_PRE():  # creating function
    NewPresentation.CrtNewPresentation()  # Creating new document
    if pyautogui.click(pyautogui.locateOnScreen(f'{project_folder}/Pattern/Insert.png', confidence=0.9, grayscale=True)) is None:
    ...
    pyautogui.press('f')  # Choosing "Image"
    Buttons.down()
    ...
    if (pyautogui.locateOnScreen(f'{project_folder}/Pattern/ErrorURL.png', confidence=0.8)) is not None:
        ...
        if (pyautogui.locateOnScreen(f'{project_folder}/Pattern/InsertedURLImagePresentation.png',
